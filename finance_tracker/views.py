...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        dflt_category_expense = ["Leisure", "Home", "Groceries", "Transportation", "Health", "Cafe", "Hobby", 
                                 "Pets", "Education", "Rent", "Gift", "Other"]
        dflt_category_income = ["Salary", "Gift", "Other"]
        categories_expense_list = [Category(user=user, name = cat, type='e') for cat in dflt_category_expense]
        categories_income_list = [Category(user=user, name = cat, type='i') for cat in dflt_category_income]
