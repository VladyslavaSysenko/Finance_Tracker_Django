...
class Account(models.Model):
    ...
    dflt_curr_code = models.ForeignKey(
        Currency,
        to_field="code",
...
class Category(models.Model):
    TYPE_CHOICES = (("e", "Expense"), ("i", "Income"))
...
class Expense(models.Model):
    ...
    currency_code = models.ForeignKey(
        Currency, to_field="code", on_delete=models.DO_NOTHING, related_name="expense"
    )
    account = models.ForeignKey(
        Account, on_delete=models.DO_NOTHING, related_name="expense_accounts"
    )
    category = models.ForeignKey(
        Category, on_delete=models.DO_NOTHING, related_name="expense_categories"
    )
...
class Income(models.Model):
    ...
    amount = models.PositiveIntegerField()
    currency_code = models.ForeignKey(
        Currency, to_field="code", on_delete=models.DO_NOTHING, related_name="income"
    )
    account = models.ForeignKey(
        Account, on_delete=models.DO_NOTHING, related_name="income_accounts"
    )
    category = models.ForeignKey(
        Category, on_delete=models.DO_NOTHING, related_name="income_categories"
    )
    comment = models.TextField(blank=True)
...
class Budget(models.Model):
    ...
    amount = models.PositiveIntegerField()
    currency_code = models.ForeignKey(
        Currency, to_field="code", on_delete=models.DO_NOTHING, related_name="budget"
    )
    account = models.ForeignKey(
